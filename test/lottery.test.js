...
contract('Lottery', (accounts) => {
    it('init', async () => {
        ...
        this.phcf = await MockBEP20.deployed();
        ...
        await this.phcf.transfer(bob, '2000', { from: minter });
        await this.phcf.transfer(alice, '2000', { from: minter });
        await this.phcf.transfer(carol, '2000', { from: minter });
    });
    ...
    it('test', async () => {
        ...
        carol=accounts[3];
        dev=accounts[4];
        await this.phcf.approve(this.lotteryProxyAddress, '1000', { from: alice });
        await this.phcf.approve(this.lotteryProxyAddress, '1000', { from: bob });
        ...
        assert.equal((await this.phcf.balanceOf(this.lotteryProxyAddress)).toString(), '418');
