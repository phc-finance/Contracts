...
contract PHCFEarlyPrivateSale {
    ...
    uint256 public totalTokensToSell = 15000000 * 10**18;          // 15000000 PHCF tokens for sell
    uint256 public phcfPerBnb = 15000 * 10**18;             // 1 BNB = 15000 PHCF
